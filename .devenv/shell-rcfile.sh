...
source "/home/wsl-vm/projects/foam-modme/.devenv/shell-env.sh"
...
__devenv_reload_apply() {
    ...
    if [ -f "/tmp/devenv-reload-625987.sh" ]; then
        ...
        source "/tmp/devenv-reload-625987.sh"
        rm -f "/tmp/devenv-reload-625987.sh"
