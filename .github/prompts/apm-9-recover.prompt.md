...
The command argument - if provided - will be listed here: `${input:args}`. If empty, then no argument was provided.
...
2. Re-read your initiation command and read every document it references - every guide, skill, and project artifact listed in its loading sequence:
   - Manager: `.github/prompts/apm-2-initiate-manager.prompt.md`
   - Worker: `.github/prompts/apm-3-initiate-worker.prompt.md`
