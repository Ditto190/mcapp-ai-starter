# APM 1.0.0 - Work Breakdown Guide
...
Present analysis visibly in chat for the User to review per `.github/skills/apm-communication/SKILL.md` §2.2 Visible Reasoning. At each approval gate, describe what was written, what comes next if approved, and ask for review.
...
3. Pause for User review:
   ...
   - If modifications needed, apply and repeat step 3.
   - If approved, state Work Breakdown is complete and all planning documents are created. Proceed to `.github/prompts/apm-1-initiate-planner.prompt.md` §4 Planning Phase Completion.
