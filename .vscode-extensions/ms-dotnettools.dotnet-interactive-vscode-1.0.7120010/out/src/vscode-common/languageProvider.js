...
exports.SignatureHelpProvider = exports.HoverProvider = exports.CompletionItemProvider = void 0;
...
async function registerLanguageProviders(clientMapper, languageServiceDelay) {
    const disposables = [];
